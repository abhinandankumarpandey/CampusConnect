...
// Generate profile link (URL-encoded email)
$encoded_email = urlencode($_SESSION['user']);
...
<head>
  <meta charset="UTF-8">
  <title>Student Announcements Home</title>
  <!-- Tailwind CSS CDN -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        <div class="flex items-center space-x-6">
          ...
          <a href="index.php" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Dashboard</a>
